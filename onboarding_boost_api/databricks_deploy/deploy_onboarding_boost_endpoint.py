...
# MAGIC %pip install -q "anyio<4" numpy pandas pyarrow databricks-sql-connector opentelemetry-api opentelemetry-sdk opentelemetry-exporter-otlp-proto-http
...
if any(importlib.util.find_spec(m) is None for m in ("databricks.sql", "pyarrow")):
